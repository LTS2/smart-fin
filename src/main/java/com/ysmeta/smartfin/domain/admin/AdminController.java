...
public class AdminController {
	 ...
	 */
	@PostMapping
	public ResponseEntity<String> registerUser(@Valid @RequestBody AdminDto.CreateAdminRequestDto createUserRequestDto,
		...
		try {
			adminApplicationService.registerUser(createUserRequestDto.toEntity());
