...
CREATE TABLE ROLE_TYPE (
    code VARCHAR(30) NOT NULL PRIMARY KEY COMMENT '역할 코드 (고유값)',
...
CREATE TABLE USER (
    ...
    email VARCHAR(100) NOT NULL COMMENT '이메일 주소 (고유값)',
...
CREATE TABLE USER_ROLE (
    id BIGINT AUTO_INCREMENT COMMENT '권한 ID',
...
--     FOREIGN KEY (code) REFERENCES ROLE_TYPE(code)
);
